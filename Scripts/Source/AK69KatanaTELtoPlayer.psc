Scriptname AK69KatanaTELtoPlayer extends ObjectReference 
...
;float FRand = utility.RandomFloat()
	...
	if (self.GetDistance(Player) > 2000)&&(FollowerRecruited.GetValue() ==1)&&(Katana.GetActorValue("WaitingForPlayer") == 0)
		;if (FRand > 0.2) 
		bCasting = True
