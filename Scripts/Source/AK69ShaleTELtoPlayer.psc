Scriptname AK69ShaleTELtoPlayer extends ObjectReference  
...
float XLoc = PolarToRectangularX(TeleportTarget.GetPositionX(), fdir, -400)
float YLoc = PolarToRectangularY(TeleportTarget.GetPositionY(), fdir, -400)	;to do: add prop instead of fixed numbers
...
utility.wait(0.1)
		...
		bCasting = False
	endIf
	if Player.IsOnMount() && AK69ShaleRidingVar.GetValue() == 1 as Float
